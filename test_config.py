...
EVALUATOR_MODEL_LIST = [EVAL_ANTHROPIC_HAIKU, EVAL_MISTRAL_SMALL, EVAL_ANTHROPIC_HAIKU, EVAL_MISTRAL_8X22B,
                        EVAL_MISTRAL_SMALL]
TEST_MODEL_LIST = [GPT3_5, EVAL_ANTHROPIC_HAIKU, MISTRAL_7B]
